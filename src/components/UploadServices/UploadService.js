...
class UploadService extends React.Component{
    ...
    handleimage(){ 
        ...
        async handlesubmit(event){
            ...
            try{
                ...
                f.child(postid+"/").set({'serviceid':postid,'servicetitle':this.state.servicetitle,'serviceprice':this.state.serviceprice,'servicedesc':this.state.servicedesc,'serviceimg':this.state.serviceimgurl}).then(()=>{
                    f1.child(postid).set({attachments:this.state.attachments}).then(()=>{
                        window.alert("Service Uploaded");
                    this.setState({
                        serviceimgurl:'',
                        servicetitle:'',
                        servicedesc:'',
    ...
    render=()=>{
        return(
            ...
            <div class="row">
            <div class="col">
                   <h2>Uploading a Service</h2>
                <div>
                <div class="col">
                    <label for="servicetitle">Post Title</label>
                ...
                <div class="col">
                    <label for="servicedesc">Post Description</label>
                ...
                <div class="col">
                    <label for="serviceimgurl">Post Image Url</label>
            ...
            <div class="col">
                ...
                <div class="cardl">
                    <div class="cardl-header">
                        <div class="classcen">
                            <img height="250" ref="https://www.pinclipart.com/picdir/big/376-3762276_tooling-and-fixturing-repair-service-icon-clipart.png"  class="imagclass" src={this.state.serviceimgurl}></img>
                            </div>
                    </div>
